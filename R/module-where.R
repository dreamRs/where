...
where_ui <- function(id) {
  ...
  tagList(
    ...
    absolutePanel(
      ...
      uiOutput(outputId = ns("searched_city"))
    )
  )
}
...
count_points <- function(data, name_city, coords) {
